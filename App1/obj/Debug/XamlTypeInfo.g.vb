...
Namespace Global.App1.App1_XamlTypeInfo
    ...
    Friend Class XamlTypeInfoProvider
        ...
        Private _typeNameTable(9) As String
        Private _typeTable(9) As Global.System.Type
        ...
        Private Sub InitTypeTables()
            ...
            _typeTable(0) = GetType(Global.App1.HubPage)
            ...
            _typeTable(3) = GetType(Global.App1.Common.NavigationHelper)
            _typeTable(4) = GetType(Global.Windows.UI.Xaml.DependencyObject)
            _typeTable(5) = GetType(Global.App1.Common.ObservableDictionary)
            _typeTable(6) = GetType(Global.System.Object)
            _typeTable(7) = GetType(Global.System.String)
            _typeTable(8) = GetType(Global.App1.ItemPage)
            _typeTable(9) = GetType(Global.App1.SectionPage)
        End Sub
        ...
        Private Function Activate_0_HubPage() As Global.System.Object
            Return New Global.App1.HubPage()
        End Function

        Private Function Activate_5_ObservableDictionary() As Global.System.Object
            Return New Global.App1.Common.ObservableDictionary()
        End Function

        Private Function Activate_8_ItemPage() As Global.System.Object
            Return New Global.App1.ItemPage()
        End Function

        Private Function Activate_9_SectionPage() As Global.System.Object
            Return New Global.App1.SectionPage()
        End Function
        ...
        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            ...
            Case 3     ' App1.Common.NavigationHelper
                userType = New Global.App1.App1_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.DependencyObject"))
            ...
            Case 5     ' App1.Common.ObservableDictionary
                userType = New Global.App1.App1_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Object"))
            ...
            Case 8     ' App1.ItemPage
                userType = New Global.App1.App1_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_8_ItemPage
                userType.AddMemberName("NavigationHelper")
                userType.AddMemberName("DefaultViewModel")
                userType.SetIsLocalType()
                xamlType = userType
        ...
        Private Function get_0_HubPage_NavigationHelper(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.App1.HubPage = CType(instance, Global.App1.HubPage)
        ...
        End Function
        Private Function get_2_ItemPage_NavigationHelper(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.App1.ItemPage = CType(instance, Global.App1.ItemPage)
            Return that.NavigationHelper
        End Function
        Private Function get_3_ItemPage_DefaultViewModel(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.App1.ItemPage = CType(instance, Global.App1.ItemPage)
            Return that.DefaultViewModel
        End Function
        Private Function get_4_SectionPage_NavigationHelper(ByVal instance As Global.System.Object) As Global.System.Object
            Dim that As Global.App1.SectionPage = CType(instance, Global.App1.SectionPage)
            Return that.NavigationHelper
        End Function
        ...
        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            ...
            Case "App1.HubPage.NavigationHelper"
                userType = CType(GetXamlTypeByName("App1.HubPage"), Global.App1.App1_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.App1.App1_XamlTypeInfo.XamlMember(Me, "NavigationHelper", "App1.Common.NavigationHelper")
                xamlMember.Getter = AddressOf get_0_HubPage_NavigationHelper
                xamlMember.SetIsReadOnly()
            Case "App1.HubPage.DefaultViewModel"
                userType = CType(GetXamlTypeByName("App1.HubPage"), Global.App1.App1_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.App1.App1_XamlTypeInfo.XamlMember(Me, "DefaultViewModel", "App1.Common.ObservableDictionary")
                xamlMember.Getter = AddressOf get_1_HubPage_DefaultViewModel
                xamlMember.SetIsReadOnly()
            Case "App1.ItemPage.NavigationHelper"
                userType = CType(GetXamlTypeByName("App1.ItemPage"), Global.App1.App1_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.App1.App1_XamlTypeInfo.XamlMember(Me, "NavigationHelper", "App1.Common.NavigationHelper")
                xamlMember.Getter = AddressOf get_2_ItemPage_NavigationHelper
                xamlMember.SetIsReadOnly()
            Case "App1.ItemPage.DefaultViewModel"
                userType = CType(GetXamlTypeByName("App1.ItemPage"), Global.App1.App1_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.App1.App1_XamlTypeInfo.XamlMember(Me, "DefaultViewModel", "App1.Common.ObservableDictionary")
                xamlMember.Getter = AddressOf get_3_ItemPage_DefaultViewModel
                xamlMember.SetIsReadOnly()
            Case "App1.SectionPage.NavigationHelper"
                userType = CType(GetXamlTypeByName("App1.SectionPage"), Global.App1.App1_XamlTypeInfo.XamlUserType)
                xamlMember = new Global.App1.App1_XamlTypeInfo.XamlMember(Me, "NavigationHelper", "App1.Common.NavigationHelper")
